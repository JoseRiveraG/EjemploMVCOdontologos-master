                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div id="alertas">
                                <?php if(!empty($_GET["respuesta"]) && $_GET["respuesta"] == "correcto"){ ?>
                                    <div class="alert alert-success alert-dismissable">
                                        ...
                                        La informacion de la Cita se ha actualizado correctamente. Puede administrar las Citas desde <a href="adminCitas.php" class="alert-link">Aqui</a> .
                                    </div>
                                <?php } ?>
                            ...
                            <?php if(!isset($_GET["IdCita"])){ ?>
                                <div class="alert alert-danger alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    No se pudo actualizar la Cita.<strong>Error: no se encontro informacion de la Cita.</strong> Puede administrar la Cita desde <a href="adminCitas.php" class="alert-link">Aqui</a>.
                                </div>
                            <?php }else{
                                $IdPaciente = $_GET["IdEspecialista"];
                                $_SESSION["IdEspecialista"] = $IdEspecialista;
                                $ObjeCita = Cita::buscarForId($IdEspecialista);
                                ?>
                                <div class="col-lg-12">
                                    <form role="form" method="post" action="../../Controlador/citaController.php?action=editar">
                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <input required value="<?php echo $ObjCita->getNombres(); ?>" data-toggle="tooltip" title="Sin Signos de puntuación o caracteres especiales" data-placement="top" maxlength="60" id="Nombres" name="Nombres" minlength="2" class="form-control newTooltip" placeholder="Ingrese Sus Nombres Completos">
                                        </div>
                                        <div class="form-group">
                                            <label>Apellidos</label>
                                            <input required value="<?php echo $ObjCita->getApellidos(); ?>" maxlength="60" id="Apellidos" name="Apellidos" minlength="2" class="form-control" placeholder="Ingrese Sus Apellidos Completos">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion</label>
                                            <input required value="<?php echo $ObjCita->getDireccion(); ?>" maxlength="60" id="Direccion" name="Direccion" minlength="7" class="form-control" placeholder="Ingrese su direccion de residencia">
                                        </div>
